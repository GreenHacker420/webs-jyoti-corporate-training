    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-700 py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto mb-8">
            A centralized platform to access corporate training content, track employee progress, and support HR with
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="bg-white rounded-2xl shadow-2xl p-12 border border-gray-100">
            ...
            <h2 className="text-4xl font-bold text-gray-800 mb-6">Access Your Learning Portal</h2>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Continue your learning journey with our comprehensive Learning Management System. Access your courses,
              track progress, and engage with expert instructors.
            </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">What's Available in Our LMS</h2>
